...
class Organization extends DatabaseFieldset {
	static get fields() {
		return ["okato", "pin_code_prefix", "resource_source", "provides", "has_schedule", "has_unit", "unit_of", "org_timezone",
						...
						"prebook_register_interval", "error_dialog_duration", "formatted_address", "mkgu_code", "qa_enabled", "auto_logout_time", "auto_warmup_time"];
	}
